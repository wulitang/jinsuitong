...
$(function(){
    ...
    $(".operate").click(function(){
        $(this).parents(".cart-list li").remove();
    });
    //购物车数量加减
    $(".num .add ,.number .add").click(function(){
        var num=$(this).siblings(".num-input").val();
        $(this).siblings(".num-input").val(++num);
    });
    $(".num .reduce,.number .reduce").click(function(){
        var num=$(this).siblings(".num-input").val();
        if(num>1){
            $(this).siblings(".num-input").val(--num);
        }
    ...
    //详情页颜色和型号的选择
    $(".choose-xh em").click(function(){
       $(this).addClass("active").siblings().removeClass("active");
        var xh=$(this).text();
        $(".xinghao").text(xh);
    });
    $(".choose-ys em").click(function(){
        $(this).addClass("active").siblings().removeClass("active");
        var ys=$(this).text();
        $(".yanse").text(ys);
    });
...
$.fn.banqh = function(can){
    ...
    $(can.pnum).find('ul').width(picminnum*picminw+10).height(picminnum*picminh);
